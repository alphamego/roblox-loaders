...
local Library do
    ...
    Library.Watermark = function(self, Name)
        ...
        local Items = { } do 
            Items["Watermark"] = Instances:Create("Frame", {
                ...
                Position = UDim2New(0.0799999982, 0, 0.0329999998, 0),
                BorderColor3 = FromRGB(12, 12, 12),
                BorderSizePixel = 2,
                AutomaticSize = Enum.AutomaticSize.XY,
                BackgroundColor3 = FromRGB(14, 17, 15)
	...
	local _sonderBase = getgenv().SCRIPTOS_SONDER_BASE
		or "https://raw.githubusercontent.com/alphamego/roblox-loaders/main/scriptos/sonder"
	local ImageHandler = loadstring(game:HttpGet(_sonderBase .. "/ImageHandler.lua"))()

	ImageHandler:New({
	    ["Sonder"] = game:HttpGet(_sonderBase .. "/Assets/sondernew.txt")
	})
