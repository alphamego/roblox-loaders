...
local images = {
    ['gradient90'] = "https://github.com/portallol/luna/blob/main/modules/gradient90.png";
    ['gradient180'] = "https://github.com/portallol/luna/blob/main/Gradient180.png";
    ['arrow_down'] = "https://github.com/dementiaenjoyer/UI-LIBRARIES/blob/main/storage/arrow_down.png";
    ['arrow_up'] = "https://github.com/dementiaenjoyer/UI-LIBRARIES/blob/main/storage/arrow_up.png";
}
...
local decode = (syn and crypt.base64.decode) or (crypt and crypt.base64decode) or base64_decode
...
local CHEAT_CLIENT = {} do
    ...
    CHEAT_CLIENT.objects.watermark = CHEAT_CLIENT:draw("Text", {Position = Vector2.new(CHEAT_CLIENT.camera.ViewportSize.X / 12, CHEAT_CLIENT.camera.ViewportSize.Y / 80), Font = 2, Size = 13, Text = "p100 wm", Outline = true, Center = true, Color = Color3.new(1,1,1)})
end

local ui = {} do
    ui.window = library.init_window("Window", {size = Vector2.new(600, 420), name = "dementia enjoyer BEST I LOVE", drag_tween = true})
    ui.pages = {} do
...
do --// setup ui
    ...
    do --// settings tab
        do --// ui settings
            ...
            ui_settings_section:new_keybind({name = "open / close", default = Enum.KeyCode.End, mode = "Toggle", flag = "ui_keybind", callback = function(state)
                library:SetOpen(state == true)
            end})
...
library.notify("LOADED ULTRA HAXX0R ELITE TO REPE SAMET IN THE BUTT")
...
print("[Velocity] ok — menu toggle: End (Settings > ui settings > open / close)")
